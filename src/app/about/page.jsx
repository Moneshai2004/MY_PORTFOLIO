            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                     This certification encompasses frontend technologies such as HTML, CSS, JavaScript, in backend frameworks like Node.js, Express, and databases such as MongoDB or MySQL.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    proficiency in Java or Kotlin programming languages, as well as a deep understanding of the Android SDK, Android Studio, and relevant design principles. .{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022{" "}
